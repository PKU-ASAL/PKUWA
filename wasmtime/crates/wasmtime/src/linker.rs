                    ...
                    |store, func_ty, export_name, instance_pre| {
                        ...
                        Func::new(
                            ...
                            move |mut caller, params, results| {
                                // println!("closure func before in Linker module Command Func::new");
        ...
        T: 'static,
    {
        ...
        for export in module.exports() {
            if let Some(func_ty) = export.ty().func() {
                // println!("before Linker command in loop");
                ...
                // println!("after Linker command in loop {}", export.name().to_owned());
